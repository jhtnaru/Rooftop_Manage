...
module pwm_Nstep (
    ...
    parameter duty_step_N   = 1024;              // Duty Step, ARR Auto Reload Register
...
//     input vauxp6, vauxn6,                       // XA1
//     input vauxp14, vauxn14,                     // XA2
//     // output reg [4:0] select_num,
//     // output reg [11:0] select_value1, select_value2,
//     // output value_valid1, value_valid2
//     output [6:0] seg_7,
//     output dp,
//     output [3:0] com,
//     output [15:0] led
...
//     sensor_cntr sensor_2ea (.clk(clk), .reset_p(reset_p),
//         .vauxp6(vauxp6), .vauxn6(vauxn6), .vauxp14(vauxp14), .vauxn14(vauxn14),
//         .adc_value1(adc_value1), .adc_value2(adc_value2));
    
//     wire start_pedge;
//     edge_detector_pos start_ed (.clk(clk), .reset_p(reset_p),
//         .cp(sw0), .p_edge(start_pedge));

//     // reg [4:0] select_cnt;
//     reg [11:0] fnd_value1, fnd_value2;
//     always @(posedge clk, posedge reset_p) begin
//         if (reset_p) begin
//             fnd_value1 <= 0;
//             fnd_value2 <= 0;
...
//                 fnd_value1 <= adc_value1;
//                 fnd_value2 <= adc_value2;
//             end
//         end
//     end
    
//     wire [11:0] fnd_value;
//     assign fnd_value = sw1 ? fnd_value1 : fnd_value2;
//     // FND 4-Digit Output
