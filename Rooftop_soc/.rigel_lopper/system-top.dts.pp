#line 1 "../platform_rooftop_2/hw/sdt/system-top.dts"
/dts-v1/;
#line 1 "../platform_rooftop_2/hw/sdt/pl.dtsi"
/ {
	cpus_microblaze_riscv_0: cpus_microblaze_riscv@0 {
		...
		microblaze_riscv_0: cpu@0 {
			...
			xlnx,use-sleep = <0>;
			xlnx,debug-trace-size = <0>;
			xlnx,pmp-granularity = <2>;
	...
	amba_pl: amba_pl {
		...
		myip_dht11_0: myip_dht11@44ac0000 {
			xlnx,rable = <0>;
			...
			xlnx,edk-iptype = "PERIPHERAL";
			reg = <0x44ac0000 0x10000>;
			xlnx,name = "myip_dht11_0";
		};
		myip_fan_0: myip_fan@44a80000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
		...
		myip_iic_txtlcd_0: myip_iic_txtlcd@44af0000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			...
			xlnx,edk-iptype = "PERIPHERAL";
			reg = <0x44af0000 0x10000>;
			xlnx,name = "myip_iic_txtlcd_0";
		};
		myip_rtc_read_0: myip_rtc_read@44ab0000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,myip-rtc-read-1.0";
			status = "okay";
			xlnx,s00-axi-addr-width = <6>;
			xlnx,ip-name = "myip_rtc_read";
			xlnx,edk-iptype = "PERIPHERAL";
			reg = <0x44ab0000 0x10000>;
			xlnx,name = "myip_rtc_read_0";
		};
		myip_sensor_adc_0: myip_sensor_adc@44ad0000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,myip-sensor-adc-1.0";
			status = "okay";
			xlnx,s00-axi-addr-width = <5>;
			xlnx,ip-name = "myip_sensor_adc";
			xlnx,edk-iptype = "PERIPHERAL";
			reg = <0x44ad0000 0x10000>;
			xlnx,name = "myip_sensor_adc_0";
		};
		myip_sensor_dgt_0: myip_sensor_dgt@44ae0000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,myip-sensor-dgt-1.0";
			status = "okay";
			xlnx,s00-axi-addr-width = <5>;
			xlnx,ip-name = "myip_sensor_dgt";
			xlnx,edk-iptype = "PERIPHERAL";
			reg = <0x44ae0000 0x10000>;
			xlnx,name = "myip_sensor_dgt_0";
		};
		myip_servo_0: myip_servo@44a00000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,myip-servo-1.0";
			status = "okay";
			xlnx,s00-axi-addr-width = <5>;
			xlnx,ip-name = "myip_servo";
			xlnx,edk-iptype = "PERIPHERAL";
			reg = <0x44a00000 0x10000>;
			xlnx,name = "myip_servo_0";
		};
		myip_servo_1: myip_servo@44a10000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,myip-servo-1.0";
			status = "okay";
			...
			xlnx,name = "myip_servo_1";
		};
		myip_servo_2: myip_servo@44a20000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,myip-servo-1.0";
			status = "okay";
			...
			xlnx,name = "myip_servo_2";
		};
		myip_servo_3: myip_servo@44a30000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,myip-servo-1.0";
			status = "okay";
			...
			xlnx,name = "myip_servo_3";
		};
		myip_servo_4: myip_servo@44a40000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,myip-servo-1.0";
			status = "okay";
			...
			xlnx,name = "myip_servo_4";
		};
		myip_servo_5: myip_servo@44a50000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,myip-servo-1.0";
			status = "okay";
			...
			xlnx,name = "myip_servo_5";
		};
		myip_servo_6: myip_servo@44a60000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,myip-servo-1.0";
			status = "okay";
			...
			xlnx,name = "myip_servo_6";
		};
		myip_stepper_0: myip_stepper@44a70000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,myip-stepper-1.0";
			status = "okay";
			xlnx,s00-axi-addr-width = <5>;
			xlnx,ip-name = "myip_stepper";
			xlnx,edk-iptype = "PERIPHERAL";
			reg = <0x44a70000 0x10000>;
			xlnx,name = "myip_stepper_0";
		};
		myip_ultrasonic_0: myip_ultrasonic@44a90000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
		...
		myip_ultrasonic_1: myip_ultrasonic@44aa0000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,myip-ultrasonic-1.0";
			status = "okay";
			...
			xlnx,name = "myip_ultrasonic_1";
		};
	};
};
#line 3 "../platform_rooftop_2/hw/sdt/system-top.dts"
/ {
	board = "basys3";
	...
	cpus_microblaze_riscv_0: cpus_microblaze_riscv@0 {
		address-map = <0x00000000 &microblaze_riscv_0_local_memory_dlmb_bram_if_cntlr_memory 0x00000000 0x20000>,
			      ...
			      <0x44a00000 &myip_servo_0 0x44a00000 0x10000>,
			      <0x44a10000 &myip_servo_1 0x44a10000 0x10000>,
			      <0x44a20000 &myip_servo_2 0x44a20000 0x10000>,
			      <0x44a30000 &myip_servo_3 0x44a30000 0x10000>,
			      <0x44a40000 &myip_servo_4 0x44a40000 0x10000>,
			      <0x44a50000 &myip_servo_5 0x44a50000 0x10000>,
			      <0x44a60000 &myip_servo_6 0x44a60000 0x10000>,
			      <0x44a70000 &myip_stepper_0 0x44a70000 0x10000>,
			      <0x44a80000 &myip_fan_0 0x44a80000 0x10000>,
			      <0x44a90000 &myip_ultrasonic_0 0x44a90000 0x10000>,
			      <0x44aa0000 &myip_ultrasonic_1 0x44aa0000 0x10000>,
			      <0x44ab0000 &myip_rtc_read_0 0x44ab0000 0x10000>,
			      <0x44ac0000 &myip_dht11_0 0x44ac0000 0x10000>,
			      <0x44ad0000 &myip_sensor_adc_0 0x44ad0000 0x10000>,
			      <0x44ae0000 &myip_sensor_dgt_0 0x44ae0000 0x10000>,
			      <0x44af0000 &myip_iic_txtlcd_0 0x44af0000 0x10000>;
